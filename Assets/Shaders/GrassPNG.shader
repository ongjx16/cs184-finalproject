...
Shader "Unlit/GrassPNG" {
    ...
    // float adjustedBias = bias;  // Start with a direct assignment
    // // Check if the current implementation of bias needs to be inverted or adjusted
    // if (planeIndex == 0 || planeIndex == 2 || planeIndex == 3) {
    //     adjustedBias = -bias;  // Example: Try inverting the bias for specific planes
    // }
